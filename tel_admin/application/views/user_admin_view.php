...
<div id="bodycontainer">
	...
	<?php echo form_open('/admin_panel/user_admin'); ?>
	
	<p><label for = "uname" /> User Name :</label>
	<?php echo $usr_info[0]->usr_name ; ?>
	<font color="#FF0000"></font></p>
	<p><label for = "passwd" /> Pass Word </label>
	<input type="text" name="passwd" id="passwd" value="<?php echo $usr_info[0]->passwd ; ?>"/></p>
	...
	<?php echo $usr_info[0]->unit; ?>
	</p>
	<?php //echo form_dropdown('usr_appt',$options,$usr_info[0]->usr_appt); ?>
	<input type="hidden" name="id" id="id" value="<?php echo $usr_info[0]->id ; ?>"/>
	<input type="hidden" name="usr_name" id="usr_name" value="<?php echo $usr_info[0]->usr_name ; ?>"/>
	<input type="hidden" name="unit" id="unit" value="<?php echo $usr_info[0]->unit ; ?>"/>
